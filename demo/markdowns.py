...
unit_string = """<p align="left">Methods for object detection and segmentation rely on large scale instance-level annotations for training, which 
        ...
        Weakly-supervised approaches draw on image-level labels tobuild detectors/segmentors, while zero/few-shot methods assume abundant instance-level data for a set of base classes,
...
dataset_title = """<h2 align="left">COCO and ImageNet Datasets</h2>"""
...
data_anomaly_title = """<h2 align="left">COCO and ImageNet Datasets for UniT</h2>"""
...
object_selection_header = """<h2 align="left" style="margin-top: 2rem;">To begin identifying objects, select an image</h2>"""
